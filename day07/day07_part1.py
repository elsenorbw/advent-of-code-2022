...
def part1(filename: str):
    ...
    # get all the directories where they have a size of less than 100K
    size_limit = 100000
    dir_sizes = [x.total_size() for x in all_dirs]
    print(dir_sizes)
    included_dir_sizes = [x for x in dir_sizes if x <= size_limit]
    print(included_dir_sizes)
    result = sum(included_dir_sizes)
